...
const I18N = {
  ...
  ht: {
    //send magiclink
    EMAIL_VERIFY_SUBJECT: 'Verifye kont Rezo Mapou ou',
    EMAIL_VERIFY_BODY: 'Bonjou,\n\nKlike sou lyen sa a pou verifye kont Rezo Mapou ou (valid pou {expiry}è):\n\n{link}\n\nSi se pa ou ki te mande sa, ignore mesaj sa a.\n\nRezo Mapou Nasyonal',
    EMAIL_LOGIN_SUBJECT: 'Lyen koneksyon Rezo Mapou',
    EMAIL_LOGIN_BODY: 'Bonjou,\n\nKlike sou lyen sa a pou konekte nan Rezo Mapou (valid pou {expiry}è):\n\n{link}\n\nSi se pa ou ki te mande sa, ignore mesaj sa a.\n\nRezo Mapou Nasyonal',
  ...
  fr: {
    // magiclink
    EMAIL_VERIFY_SUBJECT: 'Vérifiez votre compte Rezo Mapou',
    EMAIL_VERIFY_BODY: 'Bonjour,\n\nCliquez sur ce lien pour vérifier votre compte Rezo Mapou (valable {expiry}h):\n\n{link}\n\nSi vous n’avez pas fait cette demande, ignorez ce message.\n\nRezo Mapou Nasyonal',
    EMAIL_LOGIN_SUBJECT: 'Lien de connexion Rezo Mapou',
    EMAIL_LOGIN_BODY: 'Bonjour,\n\nCliquez sur ce lien pour vous connecter à Rezo Mapou (valable {expiry}h):\n\n{link}\n\nSi vous n’avez pas fait cette demande, ignorez ce message.\n\nRezo Mapou Nasyonal',
  ...
  en: {
    //magic link
    EMAIL_VERIFY_SUBJECT: 'Verify your Rezo Mapou account',
    EMAIL_VERIFY_BODY: 'Hello,\n\nClick this link to verify your Rezo Mapou account (valid for {expiry} hours):\n\n{link}\n\nIf you didn’t request this, please ignore this message.\n\nRezo Mapou Nasyonal',
    EMAIL_LOGIN_SUBJECT: 'Your Rezo Mapou login link',
    EMAIL_LOGIN_BODY: 'Hello,\n\nClick this link to log in to Rezo Mapou (valid for {expiry} hours):\n\n{link}\n\nIf you didn’t request this, please ignore this message.\n\nRezo Mapou Nasyonal',
